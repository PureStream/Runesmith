...
public class IgnisPower extends AbstractPower {
	...
	public static final String POWER_ID = "Runesmith:IgnisPower";
	...
	public void stackPower(int stackAmount) {
		...
		if (this.amount <= 0) {
			AbstractDungeon.actionManager.addToTop(new RemoveSpecificPowerAction(this.owner, this.owner, "IgnisPower"));
		}
	}
