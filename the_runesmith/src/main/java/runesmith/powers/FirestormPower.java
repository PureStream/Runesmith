...
public class FirestormPower extends AbstractPower {
    ...
    public FirestormPower(AbstractCreature owner, int amount) {
        ...
        this.amount = amount;
        updateDescription();
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("images/powers/Firestorm.png"), 0, 0, 84, 84);  //<-------- NEED SOME IMG
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("images/powers/FirestormSmall.png"), 0, 0, 32, 32); //<-------- NEED SOME IMG
    }
