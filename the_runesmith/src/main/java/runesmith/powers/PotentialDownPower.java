...
public class PotentialDownPower extends AbstractPower {
    ...
    public PotentialDownPower(AbstractCreature owner, int amount) {
        ...
        updateDescription();
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("runesmith/images/powers/PotentialDown.png"), 0, 0, 84, 84);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("runesmith/images/powers/PotentialDownSmall.png"), 0, 0, 32, 32);
    }
