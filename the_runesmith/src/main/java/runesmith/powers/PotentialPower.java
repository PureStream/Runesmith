...
public class PotentialPower extends AbstractPower {
    ...
    public PotentialPower(AbstractCreature owner, int amount) {
        ...
        this.priority = 3;
        updateDescription();
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("runesmith/images/powers/Potential.png"), 0, 0, 84, 84);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("runesmith/images/powers/PotentialSmall.png"), 0, 0, 32, 32);
    }
