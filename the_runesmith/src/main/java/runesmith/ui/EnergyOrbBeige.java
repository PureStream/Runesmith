...
public class EnergyOrbBeige extends CustomEnergyOrb {
    ...
    public void renderOrb(SpriteBatch sb, boolean enabled, float current_x, float current_y) {
        if (enabled) {
            ...
            sb.end();
            this.sbTmp.enableBlending();
            this.sbTmp.begin();
            this.fbo.begin();
            Gdx.gl.glClearColor(0.0F, 0.0F, 0.0F, 0.0F);
            Gdx.gl.glColorMask(true, true, true, true);
            this.sbTmp.setColor(Color.WHITE);
            this.sbTmp.setBlendFunction(770, 771);
            this.sbTmp.draw(this.ENERGY_BEIGE_LAYER1, current_x - 128.0F, current_y - 128.0F, 128.0F, 128.0F, 256.0F, 256.0F, ORB_IMG_SCALE, ORB_IMG_SCALE, this.angle1, 0, 0, 256, 256, false, false);
            this.sbTmp.draw(this.ENERGY_BEIGE_LAYER2, current_x - 128.0F, current_y - 128.0F, 128.0F, 128.0F, 256.0F, 256.0F, ORB_IMG_SCALE, ORB_IMG_SCALE, this.angle2, 0, 0, 256, 256, false, false);
            this.sbTmp.draw(this.ENERGY_BEIGE_LAYER3, current_x - 128.0F, current_y - 128.0F, 128.0F, 128.0F, 256.0F, 256.0F, ORB_IMG_SCALE, ORB_IMG_SCALE, this.angle3, 0, 0, 256, 256, false, false);
            this.sbTmp.setBlendFunction(770, 1);
            this.sbTmp.setColor(new Color(1.0F, 1.0F, 1.0F, 0.5F));
            this.sbTmp.draw(this.ENERGY_BEIGE_LAYER4, current_x - 128.0F, current_y - 128.0F, 128.0F, 128.0F, 256.0F, 256.0F, ORB_IMG_SCALE, ORB_IMG_SCALE, this.angle4, 0, 0, 256, 256, false, false);
            this.sbTmp.setBlendFunction(0, 770);
            this.sbTmp.setColor(new Color(1.0F, 1.0F, 1.0F, 1.0F));
            this.sbTmp.draw(this.ENERGY_BEIGE_MASK, current_x - 128.0F, current_y - 128.0F, 128.0F, 128.0F, 256.0F, 256.0F, ORB_IMG_SCALE, ORB_IMG_SCALE, 0.0F, 0, 0, 256, 256, false, false);
            this.sbTmp.setBlendFunction(770, 771);
            this.fbo.end();
            this.sbTmp.end();
            sb.begin();
            ...
            this.sbTmp.setColor(Color.WHITE);
            this.sbTmp.setBlendFunction(770, 771);
            this.sbTmp.draw(this.ENERGY_BEIGE_LAYER1D, current_x - 128.0F, current_y - 128.0F, 128.0F, 128.0F, 256.0F, 256.0F, ORB_IMG_SCALE, ORB_IMG_SCALE, this.angle1, 0, 0, 256, 256, false, false);
            this.sbTmp.draw(this.ENERGY_BEIGE_LAYER2D, current_x - 128.0F, current_y - 128.0F, 128.0F, 128.0F, 256.0F, 256.0F, ORB_IMG_SCALE, ORB_IMG_SCALE, this.angle2, 0, 0, 256, 256, false, false);
            this.sbTmp.draw(this.ENERGY_BEIGE_LAYER3D, current_x - 128.0F, current_y - 128.0F, 128.0F, 128.0F, 256.0F, 256.0F, ORB_IMG_SCALE, ORB_IMG_SCALE, this.angle3, 0, 0, 256, 256, false, false);
            this.sbTmp.draw(this.ENERGY_BEIGE_LAYER4D, current_x - 128.0F, current_y - 128.0F, 128.0F, 128.0F, 256.0F, 256.0F, ORB_IMG_SCALE, ORB_IMG_SCALE, this.angle4, 0, 0, 256, 256, false, false);
            this.sbTmp.setBlendFunction(0, 770);
            this.sbTmp.setColor(new Color(1.0F, 1.0F, 1.0F, 1.0F));
            this.sbTmp.draw(this.ENERGY_BEIGE_MASK, current_x - 128.0F, current_y - 128.0F, 128.0F, 128.0F, 256.0F, 256.0F, ORB_IMG_SCALE, ORB_IMG_SCALE, 0.0F, 0, 0, 256, 256, false, false);
            this.sbTmp.setBlendFunction(770, 771);
